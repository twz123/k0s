...
var roundtripTests = []roundtripTest{
	...
	},
	{
		...
		&Profile{
			NodeLocalLoadBalancing: &v1beta1.NodeLocalLoadBalancing{
				Enabled: true,
				Type:    v1beta1.NllbTypeTraefikProxy,
				TraefikProxy: &v1beta1.TraefikProxy{
					Image: &v1beta1.ImageSpec{
		...
		map[string]string{
			"nodeLocalLoadBalancing": `{"enabled":true,"type":"TraefikProxy","traefikProxy":{"image":{"image":"example.com/traefik","version":"latest"},"imagePullPolicy":"Always","apiServerBindPort":4711,"konnectivityServerBindPort":1337}}`,
			"konnectivity":           `{"agentPort":1337}`,
		},
	},
	{
