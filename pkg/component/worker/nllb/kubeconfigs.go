...
type kubeconfigPath struct{ regular, loadBalanced string }
type kubeconfigStat struct{ regular, loadBalanced *fileStat }

type kubeconfigPaths struct{ regular, bootstrap kubeconfigPath }
type kubeconfigStats struct{ regular, bootstrap *kubeconfigStat }
