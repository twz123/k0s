...
func (r *Reconciler) start(initialized *reconcilerInitialized) error {
	...
	updates <- func(state *podState) {
		...
		if r.envoyProxy.KonnectivityServerBindPort != nil {
			state.Shared.KonnectivityServerBindPort = uint16(*r.envoyProxy.KonnectivityServerBindPort)
		}
...
func (r *Reconciler) loadAPIServerAddressFromKubeconfig() (*hostPort, error) {
