...
func (in *NodeLocalLoadBalancing) DeepCopyInto(out *NodeLocalLoadBalancing) {
	*out = *in
	...
	if in.TraefikProxy != nil {
		in, out := &in.TraefikProxy, &out.TraefikProxy
		*out = new(TraefikProxy)
		(*in).DeepCopyInto(*out)
	}
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *TraefikProxy) DeepCopyInto(out *TraefikProxy) {
	*out = *in
	if in.Image != nil {
		in, out := &in.Image, &out.Image
		*out = new(ImageSpec)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new TraefikProxy.
func (in *TraefikProxy) DeepCopy() *TraefikProxy {
	if in == nil {
		return nil
	}
	out := new(TraefikProxy)
