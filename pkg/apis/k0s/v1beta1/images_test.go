...
func TestImagesRepoOverrideInConfiguration(t *testing.T) {
	t.Run("if_has_repository_not_empty_add_prefix_to_all_images", func(t *testing.T) {
		t.Run("default_config", func(t *testing.T) {
			...
			require.Equal(t, "my.repo/k0sproject/calico-cni:"+constant.CalicoCNIImageVersion, testingConfig.Spec.Images.Calico.CNI.URI())
			require.Equal(t, "my.repo/k0sproject/calico-kube-controllers:"+constant.CalicoKubeControllersImageVersion, testingConfig.Spec.Images.Calico.KubeControllers.URI())
			require.Equal(t, "my.repo/k0sproject/calico-node:"+constant.CalicoNodeImageVersion, testingConfig.Spec.Images.Calico.Node.URI())
			...
			require.Equal(t, "my.repo/k0sproject-kube-router-33412176133-1:"+constant.KubeRouterCNIImageVersion, testingConfig.Spec.Images.KubeRouter.CNI.URI())
