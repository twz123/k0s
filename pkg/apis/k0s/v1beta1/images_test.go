...
func TestImagesRepoOverrideInConfiguration(t *testing.T) {
	t.Run("if_has_repository_not_empty_add_prefix_to_all_images", func(t *testing.T) {
		t.Run("default_config", func(t *testing.T) {
			...
			require.Equal(t, "my.repo/k0sproject-calico-cni-23347280089-1:"+constant.CalicoCNIImageVersion, testingConfig.Spec.Images.Calico.CNI.URI())
			require.Equal(t, "my.repo/k0sproject-calico-kube-controllers-23347280089-1:"+constant.CalicoKubeControllersImageVersion, testingConfig.Spec.Images.Calico.KubeControllers.URI())
			require.Equal(t, "my.repo/k0sproject-calico-node-23347280089-1:"+constant.CalicoNodeImageVersion, testingConfig.Spec.Images.Calico.Node.URI())
