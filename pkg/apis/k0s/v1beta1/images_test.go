...
func TestImagesRepoOverrideInConfiguration(t *testing.T) {
	t.Run("if_has_repository_not_empty_add_prefix_to_all_images", func(t *testing.T) {
		t.Run("default_config", func(t *testing.T) {
			...
			require.Equal(t, "my.repo/twz123/k0s-apiserver-network-proxy-agent:"+constant.KonnectivityImageVersion, testingConfig.Spec.Images.Konnectivity.URI())
			...
			require.Equal(t, "my.repo/twz123/k0s-calico-cni:"+constant.CalicoCNIImageVersion, testingConfig.Spec.Images.Calico.CNI.URI())
			require.Equal(t, "my.repo/twz123/k0s-calico-node:"+constant.CalicoNodeImageVersion, testingConfig.Spec.Images.Calico.Node.URI())
			require.Equal(t, "my.repo/twz123/k0s-calico-kube-controllers:"+constant.KubeControllersImageVersion, testingConfig.Spec.Images.Calico.KubeControllers.URI())
