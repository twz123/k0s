...
// @see https://github.com/kubernetes/kube-proxy/blob/v0.30.2/config/v1alpha1/types.go#L27-L48
...
// @see https://github.com/kubernetes/kube-proxy/blob/v0.30.2/config/v1alpha1/types.go#L52-L78
