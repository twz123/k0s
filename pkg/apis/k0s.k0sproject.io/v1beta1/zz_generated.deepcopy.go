...
func (in *EnvoyProxy) DeepCopyInto(out *EnvoyProxy) {
	*out = *in
	...
	if in.KonnectivityAgentBindPort != nil {
		in, out := &in.KonnectivityAgentBindPort, &out.KonnectivityAgentBindPort
		*out = new(int32)
		**out = **in
	}
}
...
func (in *Network) DeepCopyInto(out *Network) {
	*out = *in
	...
	if in.NodeLocalLoadBalancer != nil {
		in, out := &in.NodeLocalLoadBalancer, &out.NodeLocalLoadBalancer
		*out = new(NodeLocalLoadBalancer)
		(*in).DeepCopyInto(*out)
	}
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *NodeLocalLoadBalancer) DeepCopyInto(out *NodeLocalLoadBalancer) {
	*out = *in
	if in.Enabled != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new NodeLocalLoadBalancer.
func (in *NodeLocalLoadBalancer) DeepCopy() *NodeLocalLoadBalancer {
	if in == nil {
		return nil
	}
	out := new(NodeLocalLoadBalancer)
