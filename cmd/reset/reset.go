...
func (c *command) reset(criSocket string) error {
	if os.Geteuid() != 0 {
	...
	// Get Cleanup Config
	cfg, err := cleanup.NewConfig(c.Debug, c.K0sVars, nodeCfg.Spec.Install.SystemUsers, criSocket)
	if err != nil {
