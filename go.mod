...
require (
	...
	k8s.io/kube-aggregator v0.24.8
	k8s.io/kubectl v0.24.8
	k8s.io/kubelet v0.24.8
	k8s.io/kubernetes v1.24.8
	k8s.io/mount-utils v0.24.8
...
require (
	...
	k8s.io/metrics v0.24.8 // indirect
...
replace (
	// https://github.com/kubernetes/kubernetes/blob/v1.24.8/go.mod#L220-L221
	github.com/docker/distribution => github.com/docker/distribution v2.8.1+incompatible
	github.com/docker/docker => github.com/docker/docker v20.10.12+incompatible

	// https://github.com/kubernetes/kubernetes/blob/v1.24.8/go.mod#L394-L405
	...
	k8s.io/sample-cli-plugin => k8s.io/sample-cli-plugin v0.24.8
	k8s.io/sample-controller => k8s.io/sample-controller v0.24.8
)
