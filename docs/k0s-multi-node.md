...
| Variable                   | Purpose                                           |
|:---------------------------|:--------------------------------------------------|
| `K0S_VERSION=v1.23.6+k0s.0 | Select the version of k0s to be installed         |
...
```shell
curl -sSLf https://get.k0s.sh | sudo K0S_VERSION=v1.23.6+k0s.0 sh
```
...
k0s    Ready    <none>   4m6s   v1.23.6+k0s.0
```
