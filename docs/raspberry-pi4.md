...
```shell
wget -O /tmp/k0s https://github.com/k0sproject/k0s/releases/download/v1.23.6%2Bk0s.0/k0s-v1.23.6+k0s.0-arm64 # replace version number!
...
node/k8s-4   Ready    <none>   5m9s    v1.23.6+k0s.0
node/k8s-5   Ready    <none>   5m      v1.23.6+k0s.0
node/k8s-6   Ready    <none>   4m45s   v1.23.6+k0s.0
