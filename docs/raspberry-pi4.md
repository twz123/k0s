...
{% set kubelet_ver = '{}+k0s'.format(k8s_version) -%}
...
{% set coredns = '{}:{}'.format(src_literal('CoreDNSImage'), src_literal('CoreDNSImageVersion')) -%}
{% set metrics_server = '{}:{}'.format(src_literal('MetricsImage'), src_literal('MetricsImageVersion')) -%}
