...
spec:
  images:
    coredns:
      image: {{{ src_literal('CoreDNSImage') }}}
      version: {{{ src_literal('CoreDNSImageVersion') }}}
```
...
{% set cali_ver = src_literal('CalicoComponentImagesVersion') -%}
{% set metrics_ver = src_literal('MetricsImageVersion') -%}
