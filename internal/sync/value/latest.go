...
//
// Use Latest when you need a value that can be updated atomically, and you
// want the previous value to be automatically invalidated. This is useful when
// you have a shared state that is updated frequently, and you don't need
// readers to keep track of every value, just the latest one. Latest makes
...
var _ Peeker[any] = (*Latest[any])(nil)
var _ Setter[any] = (*Latest[any])(nil)

// Get implements [Getter]. It retrieves the current value. If no value was
// previously set, it returns the zero value of T.
func (l *Latest[T]) Get() T {
...
// Peek implements [Peeker]. It retrieves the current value and its associated
// expiration channel. If no value was previously set, it returns the zero value
// of T and an expiration channel that is closed as soon as a value is set.
...
// Set implements [Setter]. It sets a new value and closes the expiration
// channel of the previous value.
